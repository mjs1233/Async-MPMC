...
public:
    ActionStorage(uint32_t storage_size) : m_slots(storage_size) {
...
private:
    ...
    std::atomic<TaggedHead> m_head { };
    static constexpr size_t invalid_index = std::numeric_limits<uint32_t>::max();
};
